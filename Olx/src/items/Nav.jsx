...
//           <Link
//             to="/myaccount"
//             className="py-3 px-4 text-md text-white bg-gray-800 border border-gray-400 hover:bg-gray-600 font-bold rounded-full"
//           >
//             My Account
//           </Link>
//           <Link
//             to="/post-add"
//             className="py-3 px-4 text-md border border-gray-400 text-white bg-gray-800 hover:bg-gray-600 font-bold rounded-full"
//           >
//             Post Ads
//           </Link>
...
//             <Link
//               to="/login"
//               className="py-2 px-4 text-lg text-white bg-gray-800 border border-gray-400 hover:bg-gray-00 font-bold rounded-full"
//             >
//               Login
//             </Link>
//           )}
...
//   return (
//     <nav className={`px-6 py-3 shadow-md relative z-50 ${isDarkMode ? 'bg-black text-white' : 'bg-white text-black'}`}>
//       <div className="max-w-screen-xl flex items-center justify-between mx-auto">
//         <Link to="/">
//           <img
//             src="https://web-summit-avenger.imgix.net/production/logos/original/611593121fb2c6e11e1c9d807a9f1bdc38cf199a.jpg?ixlib=rb-3.4.0&auto=format&fit=fill&fill=solid&fill-color=white&w=600&h=600"
//             className="h-20"
//             alt="Company Logo"
//             style={{ filter: isDarkMode ? 'invert(1)' : 'invert(0)' }} // Logo color based on theme
//           />
//         </Link>
...
//           <Link
//             to="/myaccount"
//             className={`py-3 px-4 text-md font-bold rounded-full border ${isDarkMode ? 'text-white bg-gray-800' : 'text-black bg-gray-200'}`}
//           >
//             My Account
//           </Link>
//           <Link
